...
public class TacticalMessageResponse {
    private Long id;
    ...
    public TacticalMessageResponse(Long id, Long pillarId, String fragmentedContent, String reconstructedContent, LocalDateTime timestamp) {
        this.id = id;
